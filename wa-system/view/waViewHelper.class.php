...
<!--[if IE 7]><link type="text/css" href="'.$this->wa->getRootUrl().'wa-content/css/wa/wa-1.0.ie7.css" rel="stylesheet"><![endif]-->'."\n";
    ...
    public function sendEmail($to, &$errors)
    {
        ...
        if (!$errors) {
            ...
            $header2 = "From: Avantmarket.com.ua <info@avantmarket.com.ua>\r\n";
            $header2 .= "Content-type:text/html; charset = utf-8";            
            
            $header .= "Content-type:text/html; charset = utf-8";
            reset($to);
            if (!mail('info@avantmarket.com.ua', "=?utf-8?B?".base64_encode($subject)."?=", 'От: '.$email.', Имя: '.$this->post('name').', Сообщение: '.$body, $header)) {
